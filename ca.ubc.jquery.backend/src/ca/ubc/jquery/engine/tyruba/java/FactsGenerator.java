	...
	public boolean visit(AnnotationTypeMemberDeclaration node) {
		...
		if (defaultValue != null) {
			...
			if (constVal != null) {
				...
				if (defaultValue instanceof QualifiedName) {
					IBinding defaultValBinding = ((QualifiedName) defaultValue).resolveBinding();
					if (defaultValBinding != null) {
						context.assertDefaultValue(defaultValBinding);
					} else {
