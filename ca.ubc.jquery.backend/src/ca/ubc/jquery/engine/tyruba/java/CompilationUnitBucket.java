...
/**
 * FactMaker is basically a wrapper class for a Tyruba RuleBaseBucket. It provides some convenience methods for inserting facts into the bucket's database, as well as a method for retrieving objects from the rulebase. The boolean outdated
 * indicates whether or not the bucket is current with the code.
 * 
