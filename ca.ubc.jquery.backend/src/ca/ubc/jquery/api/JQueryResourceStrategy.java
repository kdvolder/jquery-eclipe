...
public interface JQueryResourceStrategy {
	 ...
	 * 
	 */
	abstract public void buildWorkingSet(IAdaptable element, Collection c) throws CoreException;
	 ...
	 * given file.
	 */
	abstract public boolean rightType(IAdaptable adaptable);
	 ...
	 */
	abstract public void addApplicableElementToCollection(IAdaptable element, Collection c);
	 ...
	 */
	abstract public IAdaptable resourceDelta(IResourceDelta delta);
	 ...
	 */
	abstract public ImageDescriptor getImageDescriptor(String image);
	 ...
	 * @return A parser
	 */
	abstract public JQueryResourceParser makeParser(IAdaptable adaptable, JQueryResourceManager manager);
}